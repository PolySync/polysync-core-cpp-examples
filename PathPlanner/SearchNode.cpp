...
void SearchNode::okStateEvent( ) {
    if ( golLocX == INVALID_LOC && golLocY == INVALID_LOC ) {
        ...
        //cout << "robIndex is: " << robIndex << endl;
        //cout << "robLocX is: " << robLocX << " and robLocY: " << robLocY << endl;
        searcher->searchAStar( robIndex );
        initLocation = false;
    }
    //THREADING ISSUE!!  if statement triggers prior to searchAStar() termination
